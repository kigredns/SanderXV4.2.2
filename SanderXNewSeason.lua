...
local WindowName = SetProps(MakeElement("Label", WindowConfig.Name, 14), {
    ...
    Text = "<font color='rgb(0, 139, 255)'>Sander</font> <font color='rgb(255, 255, 255)'>X | BrookHaven | • </font> <font color='rgb(255, 139, 0)'>NEW SEASON</font> <font color='rgb(255, 255, 255)'> •</font>" -- Używamy tagów <font color='rgb(R, G, B)'>tekst</font>
})
